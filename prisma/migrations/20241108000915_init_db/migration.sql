...
-- CreateEnum
CREATE TYPE "TransactionCatagory" AS ENUM ('HOUSING', 'TRANSPORTATION', 'FOOD', 'ENTERTRAIMENT', 'HEALTH', 'UTILITY', 'SALARY', 'EDUCATION', 'OTHER');
...
CREATE TABLE "Transaction" (
    ...
    "catagory" "TransactionCatagory" NOT NULL,
